...
public class ContactLoader implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final String TAG = "PPPAAA";
...
uri= ContactsContract.CommonDataKinds.Phone.CONTENT_URI;
        ...
        String sortBy = CommonDataKinds.Phone.LOOKUP_KEY;
...
/*
        ...
        AddFragment.phoneAdapter = new ArrayAdapter<>(mContext, R.layout.list_dropdowwn_item, new ArrayList<String>());
        AddFragment.phoneSet = new HashSet<>();
        AddFragment.nameSet = new HashSet<>();
        AddFragment.nameAdapter = new ArrayAdapter<>(mContext, R.layout.list_dropdowwn_item, new ArrayList<String>());
*/
        ...
        int lookupColumnIndex = cursor.getColumnIndex(CommonDataKinds.Phone.LOOKUP_KEY);
...
//            String mimeType = cursor.getString(typeColumnIndex);
            ...
            phoneNumber= SuperFragment.removeCountryCode(phoneNumber, (Activity) mContext);/*
                AddFragment.nameSet.add(name);
                AddFragment.phoneSet.add(phoneNumber);*/
//            new HashSet<String>().add(name);
            ...
            for(String column : cursor.getColumnNames()) {
                Log.d(TAG, column + column + ": " + cursor.getString(cursor.getColumnIndex(column)) + "\n");
            }
